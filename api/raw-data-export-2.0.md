...
| idfa | （新加） | string\(36\) | idfa(identifier for advertising) | A075A0F9-32D2-4671-A78D-144B6B7D2920 | 苹果系统用于广告监测的标识符 |
| androidId | （新加） | string\(36\) | AndroidID | 6284760c2926bcd5 | 安卓系统的标识符 |
| IMEI | （新加） | string\(36\) | IMEI（International Mobile Equipment Identity） | 867459000000000 | 安卓系统的国际移动设备识别码 |
